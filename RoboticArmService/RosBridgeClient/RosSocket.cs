...
;            }
        ...
        public async  Task<bool> ConnectToRos() {

            // bool connectedStatus =  this.protocol.ConnectAsynchronously().Result;
            try
            {
                this.protocol.OnReceive +=   (sender, e) =>   Receive(sender, e);
                bool connectedStatus = await this.protocol.ConnectAsynchronously();
        ...
        private   bool Receive(object sender, EventArgs e)
        {
